...
import pl.birskidev.recipeapp.domain.util.EntityMapper
...
class RecipeNetworkMapper : EntityMapper<RecipeNetworkEntity, Recipe> {
    ...
    override fun fromEntityList(initial: List<RecipeNetworkEntity>): List<Recipe> {
        return initial.map { mapFromEntity(it) }
    }

    override fun toEntityList(initial: List<Recipe>): List<RecipeNetworkEntity> {
